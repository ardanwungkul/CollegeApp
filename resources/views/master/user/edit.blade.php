<x-app-layout>
    <div class="mx-auto max-w-3xl space-y-3">
        <p class="text-white text-lg font-bold">Edit User</p>
                ...
                <div class="space-y-3">
                    <div class="flex flex-col gap-1">
                        ...
                        <input type="text" id="name" name="name"
                            class="bg-gray-900 rounded-lg text-sm text-white" placeholder="Masukkan Nama User"
                        ...
                        <select name="group[]" id="select2" class="!bg-gray-900 rounded-lg text-sm text-white"
                            ...
                            @foreach ($group as $item)
                                <option value="{{ $item->group_name }}"
                                    {{ in_array($item->id, $user->group->pluck('id')->toArray()) ? 'selected' : '' }}>
